...
| [首页](docs/screenshots/homepage.png) | [聊天任务规划](docs/screenshots/chat-planning.png) |
| :---: | :---: |
| **首页** — 对话入口、模型选择、快捷操作 | **聊天任务规划** — 复杂请求的执行计划（如财报分析与投资建议） |
| [Paper Radar](docs/screenshots/paper-radar.png) | [Help Child](docs/screenshots/help-child.png) |
| **Paper Radar** — 发现与分析 arXiv 论文、每日简报 | **Help Child** — AI 助学、课程与进度 |

<p align="center">
  <img src="docs/screenshots/homepage.png" width="48%" alt="首页" />
  <img src="docs/screenshots/chat-planning.png" width="48%" alt="聊天任务规划" />
</p>
<p align="center">
